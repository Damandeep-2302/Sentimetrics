...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Pick the single attribute that matters most. Our engine applies a 5× weight multiplier.',
    features: null,
    tip: 'The <strong>Dealbreaker</strong> attribute receives a <strong style="color:var(--secondary)">5× weight multiplier</strong> in the validation algorithm.',
  },
];
...
// ─── Main Page Component ─────────────────────────────────────────────────────
export default function PrecisionPickWizard() {
          ...
          <div className={styles.results}>
            <div className={styles.resultsHeader}>
              ...
              <p className={styles.resultsSub}>
                ...
                {dealbreaker ? (
                  <> — Dealbreaker: <strong style={{ color: 'var(--secondary)' }}>{FEATURE_CONFIG[dealbreaker].label}</strong></>
                ) : null}
              </p>
            </div>
